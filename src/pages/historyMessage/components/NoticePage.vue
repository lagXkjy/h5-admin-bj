  ...
  <div class="currentMessage">
    <div class="messageItem" v-for="(item, index) in currentMessage"
       ...
       <div class="messageHead">
        ...
        <div class="createTime" style="font-size: 14px;color: #999999">{{moment(item.createTime).format('YYYY-MM-DD HH:mm:ss')}}</div>
       </div>  

       <div class="messageContent" @click="jumpToErrorDetail(item.id, item.backStageAbnormal.abnormalId)" :style="item.readStatus == 2 ? 'color: #999999' : ''">
